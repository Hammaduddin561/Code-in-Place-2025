...
class MusicPlayer(QMainWindow):
    def __init__(self):
        ...
        left_panel.addWidget(self.album_cover)
        ...
        lower_layout.addWidget(self.current_time_label)
        lower_layout.addStretch()
        lower_layout.addWidget(self.volume_slider)
        lower_layout.addStretch()
        lower_layout.addWidget(self.total_time_label)
        left_panel.addLayout(lower_layout)
